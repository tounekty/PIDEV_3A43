...
public class ForumView implements NavigationManager.Buildable {
    ...
    private TableView<ForumSubject> buildTable() {
        ...
        tv.getColumns().addAll(titleCol, descCol, dateCol, categoryCol, likesCol, messagesCol);
    ...
    private void onCreate() {
        try {
            ...
            if (currentUser == null) {
                statusLabel.setText("Error: user must be logged in to create a forum subject.");
                return;
            }

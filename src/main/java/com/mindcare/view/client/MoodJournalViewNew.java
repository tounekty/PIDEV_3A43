...
public class MoodJournalViewNew implements NavigationManager.Buildable {
    ...
    private Node buildMoodTab() {
        ...
        moodTable.getColumns().addAll(idCol, moodCol, dateCol, stressCol, energyCol, noteCol);
    ...
    private Node buildJournalTab() {
        ...
        TableColumn<Journal, Integer> jIdCol = new TableColumn<>("ID");
        jIdCol.setCellValueFactory(new PropertyValueFactory<>("id"));
        ...
        journalTable.getColumns().addAll(jIdCol, jTitleCol, jContentCol, jDateCol);

...
public class DossierMedicalLegacyContent implements com.mindcare.utils.NavigationManager.Buildable {
    ...
    private VBox buildEditableForm() {
        ...
        content.getStyleClass().addAll("card", "patient-file-card");
        ...
        aiSuggestionArea.getStyleClass().add("patient-file-ai-area");
        ...
        inlineError.getStyleClass().add("inline-error");
        inlineError.setWrapText(true);

        Label inlineSuccess = new Label();
        inlineSuccess.getStyleClass().add("inline-success");
    ...
    private void addField(VBox container, String label, Node input) {
        ...
        block.getStyleClass().add("patient-file-field");
        Label labelControl = new Label(label);
        labelControl.getStyleClass().add("field-label");

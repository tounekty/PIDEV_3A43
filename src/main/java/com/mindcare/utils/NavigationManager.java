...
public class NavigationManager {
    ...
    public interface ContentNavigator {
        void navigateContent(String title, Buildable contentBuilder);
    }

    private ContentNavigator customNavigator;

    public void setCustomNavigator(ContentNavigator customNavigator) {
    ...
    public void navigateContent(String title, Buildable contentBuilder) {
        if (customNavigator != null) {
            customNavigator.navigateContent(title, contentBuilder);
            return;
        }

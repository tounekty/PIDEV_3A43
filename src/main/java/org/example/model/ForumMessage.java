...
public class ForumMessage {
    ...
    public ForumMessage(int id, String contenu, LocalDateTime dateMessage, boolean anonymous, String attachmentPath,
                        String attachmentMimeType, Long attachmentSize, int idSujet, int idUser, String authorName) {
        this(id, contenu, dateMessage, anonymous, attachmentPath, attachmentMimeType, attachmentSize, idSujet, idUser, authorName, null);
    }
    ...
    public ForumMessage(int id, String contenu, LocalDateTime dateMessage, boolean anonymous, String attachmentPath,
        ...
        this(id, contenu, dateMessage, anonymous, attachmentPath, attachmentMimeType, attachmentSize,
                idSujet, idUser, authorName, parentMessageId, 0, 0, null);
    }

...
public class Main extends Application {
    ...
    private VBox buildHeader() {
        ...
        HBox actions = new HBox(12, spacer, userBadge, addHeaderButton, eventsHeaderButton, reservationsHeaderButton, statsHeaderButton, logoutButton);
    ...
    private void showLoginPage() {
        for (Node n : List.of(userBadge, addHeaderButton, eventsHeaderButton, reservationsHeaderButton, statsHeaderButton, logoutButton)) { n.setVisible(false); n.setManaged(false); }
        showPage(loginPage);
    }

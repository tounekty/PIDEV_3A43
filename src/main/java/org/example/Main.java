...
public class Main extends Application {
    ...
    private void applyRole() {
        ...
        userBadge.setText(currentUser.getEmail() + " | " + currentUser.getRole());
    ...
    private Event buildEventFromForm() {
        ...
        return new Event(title, description, LocalDateTime.of(datePicker.getValue(), time), location, cap, categoryField.getValue(), imageField.getText().trim(), currentUser != null ? currentUser.getId() : null);
    }
    ...
    private static User profileUserFromAppUser(AppUser appUser) {
        ...
        String username = appUser.getEmail() != null ? appUser.getEmail().trim() : "user";
        ...
        return new User(appUser.getId(), email, role);
    }

...
public class UserService {
    ...
    public void createUser(String email, String firstName, String lastName,
        ...
        if (userRepository.existsByEmail(normalizedEmail, null)) {
            throw new SQLException("Email deja utilise.");
        }

        String hashedPassword = BCrypt.hashpw(plainPassword.trim(), BCrypt.gensalt());
        userRepository.create(normalizedEmail, normalizedFirstName, normalizedLastName,
    ...
    public void updateUser(int userId, String email, String firstName, String lastName,
        ...
        userRepository.update(userId, normalizedEmail, normalizedFirstName, normalizedLastName,

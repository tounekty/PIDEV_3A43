...
public class UserController {
    ...
    public void createUser(String email, String firstName, String lastName,
        ...
        userService.createUser(email, firstName, lastName, plainPassword, role, bannedUntil, true);
    }
    ...
    public void updateUser(int userId, String email, String firstName, String lastName,
        ...
        userService.updateUser(userId, email, firstName, lastName, plainPasswordOrNull, role, bannedUntil);
    }
